...
\date{9 Febrarury 2021} % Date, can be changed to a custom date or \today
% -----------------------------------------
...
\end{alltt}
\begin{verbatim}
##  [1] 0.40854241 0.02098241 0.35062900 0.71365124 0.14212800 0.12797936
##  [7] 0.46068423 0.80931699 0.53369352 0.92875878
\end{verbatim}
\end{kframe}
\end{knitrout}
